    ...
    <section className="py-16 bg-primary text-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="font-heading font-bold text-3xl md:text-4xl mb-3">{t('home.testimonialsTitle')}</h2>
          <div className="w-20 h-1 bg-secondary mx-auto mb-4"></div>
          <p className="max-w-2xl mx-auto">{t('home.testimonialsDescription')}</p>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg mb-10">
          <div className="text-center mb-4">
            ...
            <p className="text-muted-foreground">{t('about.basedOnReviews')}</p>
          </div>
