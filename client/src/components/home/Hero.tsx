...
const fallbackVideo =
  "/attached_assets/Catamaran%20cruise%20around%20Ao%20Nang%20local%20islands_1750216800850.mp4";

// Variable d'environnement pour désactiver complètement la vidéo en production si nécessaire
const DISABLE_VIDEO_IN_PRODUCTION =
  import.meta.env.VITE_DISABLE_HERO_VIDEO === "true";
...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    if (shouldLoad) {
      ...
      console.log(
        "Video loading disabled via VITE_DISABLE_HERO_VIDEO environment variable",
      );
    }
  }, []);
  return (
    <section
      id="hero"
      className="relative pt-20 md:pt-28 pb-12 md:pb-16 min-h-screen flex items-center overflow-hidden"
    >
