          ...
          <div className="w-full">
            ...
            >
              ...
              <div className={`flex flex-col sm:flex-row gap-4 ${
                ...
                {(heroConfig?.buttons || [
                  {text: t('hero.cta'), url: '/tours', color: '#084F6E', style: 'filled'},
                  {text: t('hero.customTour'), url: '/custom-tour', color: '#084F6E', style: 'filled'}
