    ...
    <section className="relative h-[70vh]">
      ...
      <div className="container mx-auto px-4 relative z-20 h-full flex flex-col justify-center items-center text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
          <Link href="/tours">
            <span className="bg-primary px-8 py-3 rounded-lg font-heading font-semibold hover:bg-primary-dark transition-colors cursor-pointer">
              Explore Our Tours
            </span>
          </Link>
          <Link href="/custom-tour">
            <span className="bg-secondary px-8 py-3 rounded-lg font-heading font-semibold hover:bg-secondary-dark transition-colors cursor-pointer">
              Custom Tour
            </span>
          </Link>
        </div>
