...
export default function Gallery({ images, title, subtitle, className = "" }: GalleryProps) {
        ...
        <div className="container mx-auto px-4">
          {(title || subtitle) && (
            <div className="text-center mb-8">
              ...
              {subtitle && (
                <p className="text-xl text-gray-600 text-center mb-8">{subtitle}</p>
              )}
            </div>
          )}
            ...
            <div className="relative overflow-hidden">
              ...
              >
                {images.map((image, index) => (
                  <div
                    key={index}
                    className="flex-shrink-0 relative overflow-hidden rounded-lg shadow-md cursor-pointer hover:shadow-lg transition-shadow"
                    style={{
                  ...
                  >
                    <div className="relative h-64">
                      ...
                      <div className="absolute inset-0 bg-black/0 hover:bg-black/20 transition-colors duration-300 flex items-center justify-center">
                        <div className="opacity-0 hover:opacity-100 transition-opacity duration-300 text-white text-sm bg-black/70 px-3 py-1 rounded">
              ...
              {images.length > visibleCount && (
                <>
                  {currentIndex > 0 && (
                    <button
                      onClick={prevSlide}
                      className="absolute left-2 md:left-0 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-800 p-2 md:p-3 rounded-r-lg md:rounded-r-lg shadow-lg transition-all duration-200 hover:pl-3 md:hover:pl-4 z-10"
                  ...
                  {currentIndex < maxIndex && (
                    <button
                      onClick={nextSlide}
                      className="absolute right-2 md:right-0 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-800 p-2 md:p-3 rounded-l-lg shadow-lg transition-all duration-200 hover:pr-3 md:hover:pr-4 z-10"
      ...
      {lightboxOpen && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={closeLightbox}
              className="absolute top-6 right-6 text-white bg-black/70 hover:bg-black/90 p-3 rounded-full transition-colors z-10 shadow-lg"
            ...
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 text-white bg-black/70 hover:bg-black/90 p-3 rounded-full transition-colors shadow-lg"
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 text-white bg-black/70 hover:bg-black/90 p-3 rounded-full transition-colors shadow-lg"
