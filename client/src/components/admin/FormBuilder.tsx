...
export default function FormBuilder({ initialForm, onSave, onCancel }: FormBuilderProps) {
  ...
  const renderFieldPreview = (field: FormField) => {
    const fieldWidth = field.style?.width === 'half' ? 'w-1/2' : 
                     field.style?.width === 'third' ? 'w-1/3' : 'w-full';
    ...
    switch (field.type) {
      ...
      case 'number':
        return (
          <div className={`${fieldWidth} px-2`} style={fieldStyle}>
              ...
              {activeTab === 'style' && (
                <div className="space-y-6">
                  <Card>
                    ...
                    <CardContent>
                      <div>
                        <Label>Layout du formulaire</Label>
                        <Select
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="grid">Grille flexible</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    </CardContent>
          ...
          <div className="w-1/2 bg-gray-100">
            <div className="h-full flex flex-col">
              <div className="border-b bg-white p-4">
                ...
                <p className="text-sm text-gray-600">Aperçu en temps réel de votre formulaire</p>
              </div>
              
              <div className="flex-1 overflow-auto p-8">
                <div 
                  className="max-w-2xl mx-auto rounded-lg shadow-lg overflow-hidden"
                ...
                >
                  ...
                  <div className="p-6">
                    <div className={`
                      ${formData.layout === 'single-column' ? 'space-y-4' : 
                        formData.layout === 'two-column' ? 'grid grid-cols-2 gap-4' : 
