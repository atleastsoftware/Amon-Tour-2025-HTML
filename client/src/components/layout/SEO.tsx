...
export default function SEO({
  ...
  const finalTitle = title || t('seoMeta.defaultTitle');
  const finalDescription = description || t('seoMeta.defaultDescription');
  const finalKeywords = keywords || t('seoMeta.defaultKeywords');
