...
const translations: Record<string, Translations> = {
  en: {
    ...
    home: {
      ...
      customTripSubtitle: "Design your own journey through Thailand with our tailor-made stays: from cultural discoveries and family adventures to romantic getaways and island escapes.",
      customTripDescription: "Every itinerary is crafted to match your wishes, offering authentic experiences, quality services, and a unique immersion far from mass tourism.",
      fullName: "Full Name",
      email: "Email",
  ...
  fr: {
    ...
    home: {
      ...
      customTripTitle: "Nos voyages sur mesure",
      customTripSubtitle: "Concevez votre propre parcours à travers la Thaïlande avec nos séjours sur mesure : des découvertes culturelles aux aventures familiales, des escapades romantiques aux échappées insulaires.",
      customTripDescription: "Chaque itinéraire est conçu selon vos envies, offrant des expériences authentiques, des services de qualité, et une immersion unique loin du tourisme de masse.",
  ...
  es: {
    ...
    home: {
      ...
      customTripSubtitle: "Diseña tu propio viaje por Tailandia con nuestras estancias a medida: desde descubrimientos culturales y aventuras familiares hasta escapadas románticas y retiros en islas.",
      customTripDescription: "Cada itinerario está diseñado según tus deseos, ofreciendo experiencias auténticas, servicios de calidad y una inmersión única lejos del turismo de masas.",
