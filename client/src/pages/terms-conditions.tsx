...
export default function TermsConditions() {
  ...
  const { data: pageContent, isLoading, error } = useQuery({
    queryKey: ['/api/public/legal-page/terms-conditions'],
    queryFn: async () => {
      const response = await fetch('/api/public/legal-page/terms-conditions');
      if (!response.ok) {
    ...
    return (
      <>
        <Helmet>
          ...
          <meta name="description" content={pageContent.seoDescription || "Terms and conditions for booking and using services offered by Amon Tour."} />
