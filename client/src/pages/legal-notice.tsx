  ...
  return <>
      ...
      <main className="pt-8 pb-16">
        <div className="container mx-auto px-4">
          <h1 className="font-heading text-3xl md:text-4xl font-bold mb-6 text-center">{t('Legal Notice', {
          ...
          <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-6 md:p-8">
            ...
            <section className="mb-8">
              ...
              <address className="not-italic mb-4">{t('Flame BB', {
                defaultValue: 'Flame BB'
