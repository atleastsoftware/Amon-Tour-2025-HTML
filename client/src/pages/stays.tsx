        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {stays.map((stay, index) => <motion.div key={stay.id} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow" initial={{
              opacity: 0,
              y: 50
            }} animate={{
              opacity: 1,
              ...
              y: -5
                  ...
                  <div className="relative h-64 overflow-hidden">
                    <img src={stay.image} alt={stay.title} className="w-full h-full object-cover transition-transform duration-500 hover:scale-110" />
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-5">
                      ...
                      <div className="flex flex-wrap gap-2 mt-3">
                        {stay.features.slice(0, 3).map((feature, i) => <span key={i} className="bg-gray-100 text-gray-800 text-xs px-2 py-1 rounded-full">
                            {feature}
                          </span>)}
                        {stay.features.length > 3 && <span className="bg-gray-100 text-gray-800 text-xs px-2 py-1 rounded-full">
