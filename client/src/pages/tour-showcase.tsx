...
export default function TourShowcase() {
          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-center h-96">
              <div className="text-center">
                ...
                <p className="mt-4 text-gray-600">{t("Loadingtour", {
                  defaultValue: "Loadingtour"
                })}</p>
              </div>
            </div>
          </div>
        ...
        <div className="min-h-screen bg-gray-50 pt-24 pb-16">
          <div className="container mx-auto px-4">
            <div className="text-center py-16">
              <h1 className="text-3xl font-bold text-gray-900 mb-4">{t("Tournotfound", {
                defaultValue: "Tournotfound"
              })}</h1>
  ...
  return <>
      <SEO title={metadata?.title || `${tour.name} | Amon Tour`} description={metadata?.description || tour.shortDescription || tour.description} ogImage={metadata?.image || tour.primaryImage || tour.images[0]} canonicalUrl={metadata?.url || `https://www.amon-tour.com/tour/${token}`} keywords={metadata?.keywords?.join(', ') || ''} />
      <Header />
      
      <main className="min-h-screen bg-white pt-20">
        {/* Hero Section */}
        <section className="relative">
          <div className="h-96 bg-gradient-to-br from-primary/40 to-primary/60 relative overflow-hidden" style={{
          backgroundImage: tour.primaryImage || tour.images[0] ? `url(${tour.primaryImage || tour.images[0]})` : undefined,
              ...
              <div className="text-white">
                ...
                duration: 0.8
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-sm">
                    ...
                    <div className="flex items-center">
                      <Users className="h-4 w-4 mr-1" />{t("Upto", {
                      defaultValue: "Upto"
                    ...
                    {tour.rating && <div className="flex items-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                duration: 0.6
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">{t("Aboutthisexperience", {
                    defaultValue: "Aboutthisexperience"
                  })}</h2>
                ...
                {/* Highlights */}
                {tour.highlights && tour.highlights.length > 0 && <motion.div initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
                ...
                {/* Itinerary */}
                {tour.itinerary && tour.itinerary.length > 0 && <motion.div initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {tour.includes && tour.includes.length > 0 && <motion.div initial={{
                  opacity: 0,
                  y: 20
                }} whileInView={{
                  opacity: 1,
                  ...
                  delay: 0.3
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-4">{t('What\'s Included', {
                      defaultValue: 'What\'s Included'
                    })}</h3>
                      <ul className="list-disc list-inside space-y-2 text-gray-700">
                        {tour.includes.map((item, index) => <li key={index} className="text-green-700">{item}</li>)}
                      </ul>
                    </motion.div>}

                  {tour.excludes && tour.excludes.length > 0 && <motion.div initial={{
                  opacity: 0,
                  y: 20
                }} whileInView={{
                  opacity: 1,
                  ...
                  delay: 0.4
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-4">{t('What\'s Not Included', {
                      defaultValue: 'What\'s Not Included'
                    })}</h3>
                      <ul className="list-disc list-inside space-y-2 text-gray-700">
                        {tour.excludes.map((item, index) => <li key={index} className="text-red-700">{item}</li>)}
                      </ul>
                    </motion.div>}
                </div>
              </div>
                  ...
                  <Card className="p-6">
                    <CardContent className="p-0 space-y-6">
                      ...
                      <div className="space-y-4">
                        <Button onClick={handleBookNow} className="w-full bg-primary hover:bg-blue-700 text-white py-3 text-lg font-semibold" size="lg">{t("Booknow", {
                          defaultValue: "Booknow"
                        })}<ExternalLink className="h-5 w-5 ml-2" />
                        </Button>

                        {tour.detailsUrl && <Button onClick={handleViewDetails} variant="outline" className="w-full border-secondary text-blue-600 hover:bg-blue-50" size="lg">{t("Viewdetails", {
                      ...
                      <div className="pt-6 border-t space-y-3">
                        <div className="flex items-center text-gray-600">
                          ...
                          <span>{t("Flexiblecancellation", {
                            defaultValue: "Flexiblecancellation"
                          })}</span>
                        </div>
                        <div className="flex items-center text-gray-600">
                          <Users className="h-5 w-5 mr-3 text-blue-600" />
                          <span>{t("Smallgroupexperience", {
                            defaultValue: "Smallgroupexperience"
                          })}</span>
                        </div>
                        <div className="flex items-center text-gray-600">
                          <MapPin className="h-5 w-5 mr-3 text-blue-600" />
                          <span>{t("Localexpertguide", {
                            defaultValue: "Localexpertguide"
                          })}</span>
                        </div>
                      </div>

                      {company && <div className="pt-6 border-t text-center">
                          <p className="text-sm text-gray-500">{t("Organizedby", {
        ...
        {/* Image Gallery */}
        {tour.images && tour.images.length > 1 && <section className="py-16 bg-gray-50">
            <div className="container mx-auto px-4">
              <motion.div initial={{
            opacity: 0,
            y: 20
            ...
            duration: 0.6
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">{t("Photogallery", {
