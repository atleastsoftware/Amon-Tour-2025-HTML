      ...
      <main>
        ...
        <section className="relative h-[40vh]">
          ...
          <div className="absolute inset-0 z-0">
            <motion.img 
              src="https://images.unsplash.com/photo-1528181304800-259b08848526?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80" 
              alt="Thailand Tours" 
            ...
            <StaggerChildren className="flex flex-col items-center">
              ...
              <StaggerItem>
                <p className="text-lg md:text-xl max-w-2xl">
                  Discover our exceptional tours and immersive travel experiences.
                </p>
              </StaggerItem>
            </StaggerChildren>
          </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            {isLoading ? (
            ...
            ) : filteredTourCards && filteredTourCards.length > 0 ? (
              <StaggerChildren 
              ...
              >
                ...
                <p className="text-gray-500">We're working on adding new experiences. Check back soon!</p>
              </motion.div>
            )}
          </div>
        </section>
