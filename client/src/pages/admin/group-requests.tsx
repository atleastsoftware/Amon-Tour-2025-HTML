            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                ...
                <div className="flex items-center gap-3">
                  <UsersIcon className="h-6 w-6 sm:h-8 sm:w-8 text-amber-600" data-testid="icon-groups" />
                  <div>
                    <h1 className="text-xl sm:text-3xl font-heading text-gray-900" data-testid="heading-title">{admin.groupRequests?.title || "Groups & Corporate"}</h1>
                    <p className="text-sm sm:text-base text-gray-600" data-testid="text-subtitle">{admin.groupRequests?.subtitle || "Group and corporate travel requests"}</p>
                  </div>
                </div>
              </div>
