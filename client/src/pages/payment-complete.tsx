    ...
    switch (paymentStatus) {
      case 'loading':
        return <div className="flex flex-col items-center">
            ...
            <h2 className="font-heading font-semibold text-2xl mb-2">{t('common.vxe9rificationdupaie')}</h2>
      ...
      case 'success':
        return <div className="flex flex-col items-center">
            ...
            <h2 className="font-heading font-semibold text-2xl mb-2">{t('common.paiementrxe9ussi')}</h2>
            ...
            <div className="flex gap-4">
              ...
              <Button variant="outline" onClick={() => navigate("/tours")}>{t('common.viewothertours')}</Button>
            </div>
          </div>;
      case 'processing':
        return <div className="flex flex-col items-center">
            <Clock className="h-16 w-16 text-secondary mb-4" />
            <h2 className="font-heading font-semibold text-2xl mb-2">{t('common.paiementencoursdetra')}</h2>
            <p className="text-gray-600 text-center max-w-lg mb-6">{t('common.votrepaiementestenco')}</p>
            <div className="flex gap-4">
              <Button onClick={() => navigate("/")}>{t('common.backtohome')}</Button>
            </div>
          </div>;
      case 'error':
        return <div className="flex flex-col items-center">
            ...
            <h2 className="font-heading font-semibold text-2xl mb-2">{t('common.paiementxe9chouxe9')}</h2>
            <p className="text-gray-600 text-center max-w-lg mb-3">{t('common.uneerreurestsurvenue')}</p>
            {paymentError && <p className="text-[hsl(var(--destructive))] bg-[hsl(var(--destructive)/0.1)] p-3 rounded-md mb-6">
                {paymentError}
              </p>}
            <div className="flex gap-4">
              <Button onClick={() => navigate("/tours")}>{t('common.backtotours')}</Button>
              <Button variant="outline" onClick={() => window.history.back()}>{t('common.tryagain')}</Button>
            </div>
          </div>;
    }
  };
