  ...
  const getActualComponent = () => {
    ...
    switch (matchKey) {
      ...
      case 'popular_experiences':
        ...
        const popularTitle = (liveConfiguration?.title !== undefined ? liveConfiguration.title : block.title) || "Our Popular Experiences";
        const popularSubtitle = (liveConfiguration?.subtitle !== undefined ? liveConfiguration.subtitle : block.subtitle) || "Step off the beaten path into carefully curated experiences beyond the tourist trail.";
        
        return (
          <PopularExperiencesBlock
            title={popularTitle}
            subtitle={popularSubtitle}
            configuration={popularConfig}
            isPreview={true}
          />
        );
