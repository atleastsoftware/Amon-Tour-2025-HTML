            ...
            duration: 0.6
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                delay: index * 0.1
                    ...
                    <ul className="space-y-1">
                      {category.features.map((feature, i) => <li key={i} className="text-sm text-gray-600 flex items-center">
              ...
              delay: 0.3
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  <h4 className="font-heading font-bold text-lg mb-3">{t('What\'s Included in Our Villa Guide?', {
