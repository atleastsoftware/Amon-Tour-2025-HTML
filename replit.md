...
- **Programmatic Destination Pages**: `server/ssrDestinationRoutes.ts` adds 7 keyword-targeted SSR landing pages (`/destinations` hub + 6 individual pages: `/destinations/agence-francophone-krabi`, `/koh-phi-phi`, `/phang-nga-bay`, `/thalane-bivouac`, `/catamaran-krabi`, `/railay-beach`). Each page has 400+ words of real content, TouristTrip + FAQPage JSON-LD, WhatsApp CTAs, and internal links. All 7 URLs are in the sitemap at priority 0.8–0.9.
